        ...
        <div className = {styles.register}>
            ...
            <div className = {styles.register__form}>
                <form onSubmit={handleSubmit}>
                    ...
                    <button  type="submit" className ={styles.register__form__button}>{isloading ? 'Loading...':'Register'}
                    </button>
                </form>
            </div>
            <p className ={styles.register__form__link}>have an account? sign in <Link href="/auth/login">here</Link></p>
        </div>
    );
    };
